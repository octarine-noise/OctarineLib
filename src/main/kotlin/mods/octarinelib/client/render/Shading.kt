package mods.octarinelib.client.render

import mods.octarinelib.loader.RefsCore
import mods.octarinelib.common.*
...
class AoFaceData(val face: EnumFacing) {
    val ao = RefsCore.AmbientOcclusionFace.element!!.let {
        if (allAvailable(RefsCore.OptifineClassTransformer)) it.getDeclaredConstructor().newInstance()
        else it.getDeclaredConstructor(RefsCore.BlockModelRenderer.element!!)
